...
import { type Content, asDate, asHTML } from "@prismicio/client";
...
const dt = asDate(props.slice.primary.date_posted) as Date;

const children: WithContext<JobPosting> = {
  '@context': 'https://schema.org',
  '@type': 'JobPosting',
  'description': asHTML(props.slice.primary.description) as string,
